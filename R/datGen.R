...
#'
#' The `gen.data` function generates synthetic datasets for demonstrating the application of `Crossfit` package.
...
#' @param do.pop Logical. If `TRUE`, the function returns the counterfactual outcomes.
#' @param do.misp Logical. If `TRUE`, the function applies a transformation to the true covariates.
...
#' The continuous outcome (Y) is generated based on the covariates and treatment.
#'
#' If `do.pop` is `TRUE`, the function returns the counterfactual outcomes (Y1, Y0).
#' If `do.misp` is `TRUE`, it applies transformations to the true covariates.
#'
